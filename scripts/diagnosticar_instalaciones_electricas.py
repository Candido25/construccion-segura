...
OUT = ROOT / "docs" / "DIAGNOSTICO_INSTALACIONES_ELECTRICAS_2026-07-27.md"

TERMINOS = [
    "em010", "electrica", "eléctrica", "tablero", "interruptor", "tomacorriente",
    "conductor", "cable", "electroducto", "canalizacion", "canalización", "caja",
    "puesta a tierra", "diferencial", "termomagnetico", "termomagnético", "circuito",
    "empalme", "alumbrado", "luminaria", "medidor", "acometida", "tension", "tensión",
    "aislamiento", "polaridad", "continuidad", "resistencia", "pozo a tierra"
]
