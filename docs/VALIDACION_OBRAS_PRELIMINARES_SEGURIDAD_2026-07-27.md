# Validación normativa de obras preliminares y seguridad — 27 de julio de 2026

## Alcance

Se incorporaron **144 parámetros** y **144 preguntas** después de comparar el inventario completo de G.050 con los 982 parámetros de la versión 2.1.0.
...
- Parámetros totales: `1126`.
- Registros `validado_con_numeral`: `1092`.
- Preguntas técnicas: `2589`.
