...
OUT = ROOT / "docs" / "DIAGNOSTICO_INSTALACIONES_SANITARIAS_2026-07-27.md"

TERMINOS = [
    "is010", "agua fria", "agua caliente", "desague", "ventilacion sanitaria",
    "cisterna", "tanque elevado", "bomba", "hidroneumatico", "registro",
    "sumidero", "trampa", "sifon", "rebose", "tuberia", "aparato sanitario",
    "prueba hidraulica", "estanqueidad", "pendiente", "montante", "colector"
]
...
def main() -> None:
    ...
    lineas = [
        "# Diagnóstico de cobertura — instalaciones sanitarias",
        "",
    ...
    for norma, items in sorted(por_norma.items()):
        ...
        for item in sorted(items, key=lambda x: x["id"]):
            ...
            lineas.append(f"- `{item['id']}` | {item['categoria']} | {item['elemento']} | {item['parametro']} | {numeral}")
        lineas.append("")
