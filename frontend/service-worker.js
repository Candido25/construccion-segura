const CACHE_VERSION = "mi-casa-segura-pwa-v20";
const APP_SHELL = [
  "/",
  "/index.html",
  "/app/",
  ...
  "/app/faq-data.js?v=1",
  "/app/faq-risk-data.js?v=1",
  "/app/risk-evaluator.js?v=1",
  "/app/professional-help.js?v=1",
  "/app/risk-data.css?v=1",
  "/app/faq-search-bootstrap.js?v=1",
  "/app/faq-search.js?v=2",
  "/app/faq-search.js?v=3",
  "/app/app-experience.js?v=1",
...
self.addEventListener("fetch", (event) => {
  ...
  if (url.pathname === "/app/faq-search.js" && url.searchParams.get("v") === "2") {
    event.respondWith(
      caches.match("/app/faq-search-bootstrap.js?v=1")
        .then((response) => response || fetch("/app/faq-search-bootstrap.js?v=1"))
    );
    return;
  }
